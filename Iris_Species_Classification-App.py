...
# Creating a function 'prediction()' that accepts 'SepalLength', 'SepalWidth', 'PetalLength' and 'PetalWidth' as inputs and returns the species name.
@st.cache()
...
# When 'Predict' button is pushed, the 'prediction()' function must be called and the value returned by it must be stored in a variable, say 'species_type'. 
if st.button("Predict"):
	species_type = prediction(s_length, s_width, p_length, p_width)
	# Printing the value of 'species_type' and 'score' variable
